                ...
                >
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={(event) =>
                            handleBackCheckboxChange(event, backImageID)
                          }
                        />
                      }
                    />
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      variant="outlined"
                      onClick={() => handleRemoveBackImage(backImageID)}
                      disabled={!isBackChecked && !backImage}
                    >
                      Remove
                    </Button>
                ...
                >
                  <Box display="flex" justifyContent="space-between">
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={
                            isBackEMBChecked || backEMBImage ? true : false
                          }
                          onChange={(event) =>
                            handleBackEMBCheckboxChange(event, backEMBImageID)
                          }
                        />
                      }
                      label="EMB"
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      variant="outlined"
                      onClick={() => handleRemoveBackEMBImage(backEMBImageID)}
                      disabled={!isBackEMBChecked && !backEMBImage}
                    >
                      Remove
                    </Button>
                ...
                >
                  <Box display="flex" justifyContent="space-between">
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={
                            isBackSUBChecked || backSUBImage ? true : false
                          }
                          onChange={(event) =>
                            handleBackSUBCheckboxChange(event, backSUBImageID)
                          }
                        />
                      }
                      label="SUB"
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      variant="outlined"
                      color="error"
                      onClick={() => handleRemoveBackSUBImage(backSUBImageID)}
                      disabled={!isBackSUBChecked && !backSUBImage}
                    >
                      Remove
                    </Button>
                ...
                >
                  <Box display="flex" justifyContent="space-between">
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={
                            isBackSPrintChecked || backSPrintImage
                              ? true
                              : false
                          }
                          onChange={(event) =>
                            handleBackSPrintCheckboxChange(
                              event,
                              backSPrintImageID
                            )
                          }
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      onClick={() =>
                        handleRemoveBackSPrintImage(backSPrintImageID)
                      }
                      disabled={!isBackSPrintChecked && !backSPrintImage}
                    >
                      Remove
                ...
                >
                  <Box display="flex" justifyContent="space-between">
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={
                            isBackDTFChecked || backDTFImage ? true : false
                          }
                          onChange={(event) =>
                            handleBackDTFCheckboxChange(event, backDTFImageID)
                          }
                        />
                      }
                      label="DTF"
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      variant="outlined"
                      color="error"
                      onClick={() => handleRemoveBackDTFImage(backDTFImageID)}
                      disabled={!isBackDTFChecked && !backDTFImage}
                    >
                      Remove
                    </Button>
