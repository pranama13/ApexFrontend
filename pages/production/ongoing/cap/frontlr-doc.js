                    ...
                    >
                      ...
                      <Box mt={1}>
                        ...
                        <Button
                          ...
                          variant="outlined"
                          onClick={() =>
                            handleRemoveFrontLImage(frontLImageID)
                          }
                        >
                          Remove
                        </Button>
                    ...
                    >
                      ...
                      <Box mt={1}>
                        ...
                        <Button
                          ...
                          variant="outlined"
                          onClick={() =>
                            handleRemoveFrontRImage(frontRImageID)
                          }
                        >
                          Remove
                        </Button>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      variant="outlined"
                      onClick={() =>
                        handleRemoveFrontLREMBImage(frontLREMBImageID)
                      }
                    >
                      Remove
                    </Button>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      onClick={() =>
                        handleRemoveFrontLRSUBImage(frontLRSUBImageID)
                      }
                      disabled={!isFrontLRSUBChecked && !frontLRSUBImage}
                    >
                      Remove
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      onClick={() =>
                        handleRemoveFrontLRSPrintImage(frontLRSPrintImageID)
                      }
                      disabled={!isFrontLRSPrintChecked && !frontLRSPrintImage}
                    >
                      Remove
                    </Button>
                  </Box>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      onClick={() =>
                        handleRemoveFrontLRDTFImage(frontLRDTFImageID)
                      }
                      disabled={!isFrontLRDTFChecked && !frontLRDTFImage}
                    >
                      Remove
