...
export default function SelectSizes() {
  ...
  const NavigationNext = (Inquiry, inquirySizeList) => {
    const routes = {
      1: "/production/ongoing/tshirt/neck/",
      2: "/production/ongoing/shirt/coller/",
      3: "/production/ongoing/cap/info/",
      4: "/production/ongoing/visor/components/",
      5: "/production/ongoing/hat/document-panel/",
      6: "/production/ongoing/bag/document-panel/",
      7: "/production/ongoing/bottom/component/",
      8: "/production/ongoing/short/component/",
    };
    ...
    if (inquirySizeList.length > 0) {
      ...
      toast.error("You have to enter sizes first.");
    }
  };
      ...
      >
        <Grid item xs={12} display="flex" justifyContent="space-between">
          ...
          <Box display="flex" sx={{ gap: "10px" }}>
            <Link href={`/production/ongoing/color-code/?inqType=${inqType}`}>
            ...
            <Button
              ...
              onClick={() => NavigationNext(inqType, inquirySizeList)}
            >
              next
            </Button>
          </Box>
