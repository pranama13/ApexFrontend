...
export default function SelectFabric() {
  ...
  const navToSummary = (Inquiry) => {
    const routes = {
      1: "/production/ongoing/tshirt/summary/",
      2: "/production/ongoing/shirt/summary/",
      3: "/production/ongoing/cap/summary/",
      4: "/production/ongoing/visor/summary/",
      5: "/production/ongoing/hat/summary/",
      6: "/production/ongoing/bag/summary/",
      7: "/production/ongoing/bottom/summary/",
      8: "/production/ongoing/short/summary/",
    };
    router.push({
      ...
      >
        <Grid item xs={12} display="flex" justifyContent="space-between">
          ...
          <Box display="flex" sx={{ gap: "10px" }}>
            ...
            <Link
              href={{
                pathname: `/production/ongoing/color-code/`,
                query: {
                  inqType: inqType,
                },
              }}
