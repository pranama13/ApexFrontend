                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      variant="outlined"
                      onClick={() => handleRemoveFrontLImage(frontLImageID)}
                    >
                      Remove
                    </Button>
                  </Box>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      variant="outlined"
                      onClick={() => handleRemoveFrontLEMBImage(frontLEMBImageID)}
                    >
                      Remove
                    </Button>
                  </Box>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      variant="outlined"
                      color="error"
                      onClick={() => handleRemoveFrontLSUBImage(frontLSUBImageID)}
                      disabled={!isFrontLSUBChecked && !frontLSUBImage}
                    >
                      Remove
                    </Button>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      onClick={() =>
                        handleRemoveFrontLSPrintImage(frontLSPrintImageID)
                      }
                      disabled={!isFrontLSPrintChecked && !frontLSPrintImage}
                    >
                      Remove
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      variant="outlined"
                      color="error"
                      onClick={() => handleRemoveFrontLDTFImage(frontLDTFImageID)}
                      disabled={!isFrontLDTFChecked && !frontLDTFImage}
                    >
                      Remove
                    </Button>
