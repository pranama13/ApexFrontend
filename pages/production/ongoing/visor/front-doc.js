                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={(event) =>
                            handleFrontCheckboxChange(event, frontImageID)
                          }
                        />
                      }
                    />
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={(event) =>
                            handleFrontEMBCheckboxChange(event, frontEMBImageID)
                          }
                        />
                      }
                      label="EMB"
                ...
                >
                  <Box display="flex" justifyContent="space-between">
                    <FormControlLabel
                      ...
                      onChange={(event) =>
                        handleFrontSUBCheckboxChange(event, frontSUBImageID)
                      }
                      label="SUB"
                    />
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={(event) =>
                            handleFrontSPrintCheckboxChange(
                              event,
                              frontSPrintImageID
                            )
                          }
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={(event) =>
                            handleFrontDTFCheckboxChange(event, frontDTFImageID)
                          }
                        />
                      }
                      label="DTF"
