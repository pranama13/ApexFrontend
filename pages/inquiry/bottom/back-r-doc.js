                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      variant="outlined"
                      onClick={() => handleRemoveBackRImage(backRImageID)}
                      disabled={!isBackRChecked && !backRImage}
                    >
                      Remove
                    </Button>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      variant="outlined"
                      onClick={()=>handleRemoveBackREMBImage(backREMBImageID)}
                      disabled={!isBackREMBChecked && !backREMBImage}
                    >
                      Remove
                    </Button>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      variant="outlined"
                      color="error"
                      onClick={()=>handleRemoveBackRSUBImage(backRSUBImageID)}
                      disabled={!isBackRSUBChecked && !backRSUBImage}
                    >
                      Remove
                    </Button>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      variant="outlined"
                      color="error"
                      onClick={()=>handleRemoveBackRSPrintImage(backRSPrintImageID)}
                      disabled={!isBackRSPrintChecked && !backRSPrintImage}
                    >
                      Remove
                    </Button>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      variant="outlined"
                      color="error"
                      onClick={()=>handleRemoveBackRDTFImage(backRDTFImageID)}
                      disabled={!isBackRDTFChecked && !backRDTFImage}
                    >
                      Remove
                    </Button>
