                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      variant="outlined"
                      onClick={() => handleRemoveFrontRImage(frontRImageID)}
                    >
                      Remove
                    </Button>
                  </Box>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      variant="outlined"
                      onClick={() => handleRemoveFrontREMBImage(frontREMBImageID)}
                    >
                      Remove
                    </Button>
                  </Box>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      variant="outlined"
                      color="error"
                      onClick={() => handleRemoveFrontRSUBImage(frontRSUBImageID)}
                      disabled={!isFrontRSUBChecked && !frontRSUBImage}
                    >
                      Remove
                    </Button>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      color="error"
                      onClick={() =>
                        handleRemoveFrontRSPrintImage(frontRSPrintImageID)
                      }
                      disabled={!isFrontRSPrintChecked && !frontRSPrintImage}
                    >
                      Remove
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Button
                      ...
                      variant="outlined"
                      color="error"
                      onClick={() => handleRemoveFrontRDTFImage(frontRDTFImageID)}
                      disabled={!isFrontRDTFChecked && !frontRDTFImage}
                    >
                      Remove
                    </Button>
