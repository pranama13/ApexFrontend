...
export default function BackLDocument({ inquiry, onUpload }) {
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Box mt={1} display="flex" justifyContent="space-between">
                      <AddFileRemark id={backLImageID} checked={isBackLChecked} />
                      <Tooltip onClick={() => handleRemoveBackLImage(backLImageID)} title="Remove" placement="top">
                        <span>
                          <IconButton disabled={!isBackLChecked && !backLImage} aria-label="edit">
                            <DeleteIcon color={isBackLChecked ? "error" : ""} fontSize="medium" />
                          </IconButton>
                        </span>
                      </Tooltip>
                    </Box>
              ...
              <Grid item xs={12} lg={2}>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Box mt={1} display="flex" justifyContent="space-between">
                      <AddFileRemark id={backLEMBImageID} checked={isBackLEMBChecked} />
                      <Tooltip onClick={() => handleRemoveBackLEMBImage(backLEMBImageID)} title="Remove" placement="top">
                        <span>
                          <IconButton disabled={!isBackLEMBChecked && !backLEMBImage} aria-label="edit">
                            <DeleteIcon color={isBackLEMBChecked ? "error" : ""} fontSize="medium" />
                          </IconButton>
                        </span>
                      </Tooltip>
                    </Box>
              ...
              <Grid item xs={12} lg={2}>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Box mt={1} display="flex" justifyContent="space-between">
                      <AddFileRemark id={backLSUBImageID} checked={isBackLSUBChecked} />
                      <Tooltip onClick={() => handleRemoveBackLSUBImage(backLSUBImageID)} title="Remove" placement="top">
                        <span>
                          <IconButton disabled={!isBackLSUBChecked && !backLSUBImage} aria-label="edit">
                            <DeleteIcon color={isBackLSUBChecked ? "error" : ""} fontSize="medium" />
                          </IconButton>
                        </span>
                      </Tooltip>
                    </Box>
              ...
              <Grid item xs={12} lg={2}>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Box mt={1} display="flex" justifyContent="space-between">
                      <AddFileRemark id={backLSPrintImageID} checked={isBackLSPrintChecked} />
                      <Tooltip onClick={() => handleRemoveBackLSPrintImage(backLSPrintImageID)} title="Remove" placement="top">
                        <span>
                          <IconButton disabled={!isBackLSPrintChecked && !backLSPrintImage} aria-label="edit">
                            <DeleteIcon color={isBackLSPrintChecked ? "error" : ""} fontSize="medium" />
                          </IconButton>
                        </span>
                      </Tooltip>
                    </Box>
              ...
              <Grid item xs={12} lg={2}>
                ...
                >
                  ...
                  <Box mt={1}>
                    ...
                    <Box mt={1} display="flex" justifyContent="space-between">
                      <AddFileRemark id={backLDTFImageID} checked={isBackLDTFChecked} />
                      <Tooltip onClick={() => handleRemoveBackLDTFImage(backLDTFImageID)} title="Remove" placement="top">
                        <span>
                          <IconButton disabled={!isBackLDTFChecked && !backLDTFImage} aria-label="edit">
                            <DeleteIcon color={isBackLDTFChecked ? "error" : ""} fontSize="medium" />
                          </IconButton>
                        </span>
                      </Tooltip>
                    </Box>
