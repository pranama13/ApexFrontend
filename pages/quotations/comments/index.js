        ...
        <Box sx={style} className="bg-black">
          <Grid container>
            ...
            <Grid item xs={12} my={2}>
              <AddFollowUps fetchItems={fetchComments} sentQuotId={item.id}/>
            </Grid>
          </Grid>
                  ...
                  <Table aria-label="simple table" className="dark-table">
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell>Next Follow Up Date & Time</TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
                      {comments.length === 0 ? (
                        ...
                        comments.map((item, index) => (
                          <TableRow key={index}>
                            ...
                            <TableCell>{formatDateWithTime(item.nextFollowUpDateTime)}</TableCell>
                          </TableRow>
                        ))
                      )}
                    </TableBody>
