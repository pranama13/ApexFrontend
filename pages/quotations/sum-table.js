    ...
    const bodyData = [
      {
        ...
        UnitCost: value ? value : parseFloat(0),
        Quantity: item.quantity,
        TotalCost: parseFloat((value * item.quantity).toFixed(2)),
        ApprovedUnitCost: value ? value : parseFloat(0),
    ...
    const bodyData = [
      {
        ...
        UnitCost: updatedpatternunitcost
          ...
          : parseFloat(0),
        Quantity: item.quantity,
        TotalCost: value ? value : parseFloat(0),
        ApprovedUnitCost: updatedpatternunitcost
          ? updatedpatternunitcost
          : parseFloat(0),
        ApprovedQuantity: item.quantity,
        ApprovedTotalCost: value ? value : parseFloat(0),
      },
    ];
    fetch(`${BASE_URL}/Inquiry/UpdateSummeryLine`, {
      method: "POST",
