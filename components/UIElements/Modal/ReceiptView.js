...
export default function ReceiptView({ advance, full }) {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await fetch("/api/receipts"); // Adjust the endpoint
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.section}>
          ...
          <Text style={styles.receiptNo}>Receipt Number : 1245</Text>
          <Text style={styles.add}>Bill To : Address Line 01</Text>
          <View
            style={{
              flexDirection: "row",
              marginTop: "10px",
          ...
          >
            ...
            <View style={{ flexGrow: 1 }}>
              ...
              <Text style={styles.tablecell6}>10</Text>
              <Text style={styles.tablecell6}>10</Text>
              <Text style={styles.tablecell6}>10</Text>
              <Text style={styles.tablecell6}>10</Text>
            </View>
